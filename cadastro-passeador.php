...
<body>
    ...
    <div id="box-cadastro">
        <form action="cadastroPasseador.php" method="POST">
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control input-cadastro" type="text" placeholder="Data Nascimento" name="add_date"
                        data-toggle="tooltip" data-placement="top" title="Data de Nascimento" style="margin-bottom:15px;margin-top:2px;">
                </div>

                <div class="form-group col-md-6">
                    <input class="form-control input-cadastro" placeholder="Sobrenome" name="add_last_name" data-toggle="tooltip"
                        data-placement="top" title="Sobrenome">
            ...
            <div class="form-group">
                <textarea class="form-control input-cadastro" placeholder="Escreva uma breve mensagem, o porquê gostaria de tornar-se passeador."
                    name="add_message" style="margin-bottom:15px;margin-top:2px;" id="exampleFormControlTextarea1" rows="4"
                    data-toggle="tooltip" data-placement="top" title="Por que gostaria de tornar-se passeador?"></textarea>
            </div>
