<?php
if($_SESSION['perm'][4][1] != 1 && $_SESSION['perm'][0][1] != 1){
...
if(isset($_POST['btnAdicionar'])){
    if(validaDados()){
        ...
        $sql = 'CALL criarPasseador("'.$cpf.'", "'.$rg.'", "'.$_POST['nmPessoa'].'", "'.$_POST['cdEmail'].'", "'.$_POST['novasenha1'].'", "'.$_POST['dtNascimento'].'");';
...
<div class="row justify-content-center">
    ...
    <div class="col-lg-4 col-md-4">
        <form class="form-group" name="addusuario" action="page-admin-funcoes.php?funcao=addpas" method="POST">
            ...
            <div class="form-group">
                <button type="submit" name="btnAdicionar" class="btn btn-danger btn-lg btn-block" >Adicionar Passeador</button>
            </div>
            <script>  
