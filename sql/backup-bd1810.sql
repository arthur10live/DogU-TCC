...
--
-- Host: 127.0.0.1
-- Tempo de geração: 18-Out-2019 às 23:39
...
--
-- Banco de dados: `u765863036_dogu`
--
CREATE DATABASE IF NOT EXISTS `u765863036_dogu` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `u765863036_dogu`;
...
DROP TABLE IF EXISTS `administrador_permissao`;
...
--
-- Acionadores `administrador_permissao`
--
DROP TRIGGER IF EXISTS `tr_MonitoraInsert_administrador_permissao`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraInsert_administrador_permissao` AFTER INSERT ON `administrador_permissao` FOR EACH ROW begin
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_MonitoraUpdate_administrador_permissao`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraUpdate_administrador_permissao` BEFORE UPDATE ON `administrador_permissao` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
--
-- Acionadores `cliente_pet`
--
DROP TRIGGER IF EXISTS `tr_MonitoraInsert_cliente_pet`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraInsert_cliente_pet` AFTER INSERT ON `cliente_pet` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_MonitoraUpdate_cliente_pet`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraUpdate_cliente_pet` BEFORE UPDATE ON `cliente_pet` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
--
-- Acionadores `pessoa_endereco`
--
DROP TRIGGER IF EXISTS `tr_MonitoraInsert_pessoa_endereco`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraInsert_pessoa_endereco` AFTER INSERT ON `pessoa_endereco` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_MonitoraUpdate_pessoa_endereco`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraUpdate_pessoa_endereco` BEFORE UPDATE ON `pessoa_endereco` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
--
-- Acionadores `pessoa_telefone`
--
DROP TRIGGER IF EXISTS `tr_MonitoraInsert_pessoa_telefone`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraInsert_pessoa_telefone` AFTER INSERT ON `pessoa_telefone` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_MonitoraUpdate_pessoa_telefone`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraUpdate_pessoa_telefone` BEFORE UPDATE ON `pessoa_telefone` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
--
-- Acionadores `tb_administrador`
--
DROP TRIGGER IF EXISTS `tr_MonitoraInsert_tb_administrador`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraInsert_tb_administrador` AFTER INSERT ON `tb_administrador` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_MonitoraUpdate_tb_administrador`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraUpdate_tb_administrador` BEFORE UPDATE ON `tb_administrador` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
--
-- Acionadores `tb_animal`
--
DROP TRIGGER IF EXISTS `tr_MonitoraInsert_tb_animal`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraInsert_tb_animal` AFTER INSERT ON `tb_animal` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_MonitoraUpdate_tb_animal`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraUpdate_tb_animal` BEFORE UPDATE ON `tb_animal` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
CREATE TABLE `tb_auditoria` (
  `cd_auditoria` int(11) NOT NULL,
  `nm_usuario` varchar(70) DEFAULT NULL,
  `sg_tipo_auditoria` char(3) DEFAULT NULL,
  `dt_acao` date DEFAULT NULL,
  `hr_acao` time DEFAULT NULL,
  `ds_acao` text DEFAULT NULL
...
INSERT INTO `tb_auditoria` (`cd_auditoria`, `nm_usuario`, `sg_tipo_auditoria`, `dt_acao`, `hr_acao`, `ds_acao`) VALUES
(1, 'TESTE', 'INS', '2019-10-18', '21:35:53', 'TESTE');
...
--
-- Acionadores `tb_bairro`
--
DROP TRIGGER IF EXISTS `tr_MonitoraInsert_tb_bairro`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraInsert_tb_bairro` AFTER INSERT ON `tb_bairro` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_MonitoraUpdate_tb_bairro`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraUpdate_tb_bairro` BEFORE UPDATE ON `tb_bairro` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
--
DROP TRIGGER IF EXISTS `tr_MonitoraInsert_tb_cidade`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraInsert_tb_cidade` AFTER INSERT ON `tb_cidade` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_MonitoraUpdate_tb_cidade`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraUpdate_tb_cidade` BEFORE UPDATE ON `tb_cidade` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
--
DROP TRIGGER IF EXISTS `tr_MonitoraInsert_tb_cliente`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraInsert_tb_cliente` AFTER INSERT ON `tb_cliente` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_MonitoraUpdate_tb_cliente`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraUpdate_tb_cliente` BEFORE UPDATE ON `tb_cliente` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
INSERT INTO `tb_denuncia` (`cd_denuncia`, `cd_passeio`, `cd_passeador`, `cd_cliente`, `cd_pet`, `cd_tipo_denuncia`, `ds_denuncia`) VALUES
(1, 1, 2, 3, 4, 1, 'TESTE');

--
-- Acionadores `tb_denuncia`
--
DROP TRIGGER IF EXISTS `tr_MonitoraInsert_tb_denuncia`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraInsert_tb_denuncia` AFTER INSERT ON `tb_denuncia` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_MonitoraUpdate_tb_denuncia`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraUpdate_tb_denuncia` BEFORE UPDATE ON `tb_denuncia` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
--
DROP TRIGGER IF EXISTS `tr_MonitoraInsert_tb_endereco`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraInsert_tb_endereco` AFTER INSERT ON `tb_endereco` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_MonitoraUpdate_tb_endereco`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraUpdate_tb_endereco` BEFORE UPDATE ON `tb_endereco` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
DROP TABLE IF EXISTS `tb_grupo_passeio`;
...
--
-- Extraindo dados da tabela `tb_grupo_passeio`
--

INSERT INTO `tb_grupo_passeio` (`cd_passeio`, `cd_cliente`, `cd_pet`) VALUES
(1, 1, 9);

--
-- Acionadores `tb_grupo_passeio`
--
DROP TRIGGER IF EXISTS `tr_MonitoraInsert_tb_grupo_passeio`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraInsert_tb_grupo_passeio` AFTER INSERT ON `tb_grupo_passeio` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_MonitoraUpdate_tb_grupo_passeio`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraUpdate_tb_grupo_passeio` BEFORE UPDATE ON `tb_grupo_passeio` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
(19, 'admin@admin.com', '21232f297a57a5a743894a0e4a801fc3'),
...
--
-- Acionadores `tb_login`
--
DROP TRIGGER IF EXISTS `tr_MonitoraInsert_tb_login`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraInsert_tb_login` AFTER INSERT ON `tb_login` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_MonitoraUpdate_tb_login`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraUpdate_tb_login` BEFORE UPDATE ON `tb_login` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
--
-- Acionadores `tb_nivel`
--
DROP TRIGGER IF EXISTS `tr_MonitoraInsert_tb_nivel`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraInsert_tb_nivel` AFTER INSERT ON `tb_nivel` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_MonitoraUpdate_tb_nivel`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraUpdate_tb_nivel` BEFORE UPDATE ON `tb_nivel` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
DROP TABLE IF EXISTS `tb_passeador`;
...
--
-- Acionadores `tb_passeador`
--
DROP TRIGGER IF EXISTS `tr_MonitoraInsert_tb_passeador`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraInsert_tb_passeador` AFTER INSERT ON `tb_passeador` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_MonitoraUpdate_tb_passeador`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraUpdate_tb_passeador` BEFORE UPDATE ON `tb_passeador` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
DROP TABLE IF EXISTS `tb_passeio`;
...
--
-- Extraindo dados da tabela `tb_passeio`
--

INSERT INTO `tb_passeio` (`cd_passeio`, `cd_passeador`, `ds_trajeto`) VALUES
(1, 1, 'TESTE');

--
-- Acionadores `tb_passeio`
--
DROP TRIGGER IF EXISTS `tr_MonitoraInsert_tb_passeio`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraInsert_tb_passeio` AFTER INSERT ON `tb_passeio` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_MonitoraUpdate_tb_passeio`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraUpdate_tb_passeio` BEFORE UPDATE ON `tb_passeio` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
--
-- Acionadores `tb_permissao`
--
DROP TRIGGER IF EXISTS `tr_MonitoraInsert_tb_permissao`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraInsert_tb_permissao` AFTER INSERT ON `tb_permissao` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_MonitoraUpdate_tb_permissao`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraUpdate_tb_permissao` BEFORE UPDATE ON `tb_permissao` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
(19, '00000000000', '000000000', 'ADMINISTRADOR TESTE', NULL),
...
--
-- Acionadores `tb_pessoa`
--
DROP TRIGGER IF EXISTS `tr_MonitoraInsert_tb_pessoa`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraInsert_tb_pessoa` AFTER INSERT ON `tb_pessoa` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_MonitoraUpdate_tb_pessoa`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraUpdate_tb_pessoa` BEFORE UPDATE ON `tb_pessoa` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
-- Acionadores `tb_pet`
--
DROP TRIGGER IF EXISTS `tr_MonitoraInsert_tb_pet`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraInsert_tb_pet` AFTER INSERT ON `tb_pet` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_MonitoraUpdate_tb_pet`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraUpdate_tb_pet` BEFORE UPDATE ON `tb_pet` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
--
-- Acionadores `tb_porte`
--
DROP TRIGGER IF EXISTS `tr_MonitoraInsert_tb_porte`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraInsert_tb_porte` AFTER INSERT ON `tb_porte` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_MonitoraUpdate_tb_porte`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraUpdate_tb_porte` BEFORE UPDATE ON `tb_porte` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
--
-- Acionadores `tb_situacao`
--
DROP TRIGGER IF EXISTS `tr_MonitoraInsert_tb_situacao`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraInsert_tb_situacao` AFTER INSERT ON `tb_situacao` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_MonitoraUpdate_tb_situacao`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraUpdate_tb_situacao` BEFORE UPDATE ON `tb_situacao` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
-- Acionadores `tb_sos`
--
DROP TRIGGER IF EXISTS `tr_MonitoraInsert_tb_sos`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraInsert_tb_sos` AFTER INSERT ON `tb_sos` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_MonitoraUpdate_tb_sos`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraUpdate_tb_sos` BEFORE UPDATE ON `tb_sos` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
--
-- Acionadores `tb_telefone`
--
DROP TRIGGER IF EXISTS `tr_MonitoraInsert_tb_telefone`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraInsert_tb_telefone` AFTER INSERT ON `tb_telefone` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_MonitoraUpdate_tb_telefone`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraUpdate_tb_telefone` BEFORE UPDATE ON `tb_telefone` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
--
-- Acionadores `tb_tipo_animal`
--
DROP TRIGGER IF EXISTS `tr_MonitoraInsert_tb_tipo_animal`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraInsert_tb_tipo_animal` AFTER INSERT ON `tb_tipo_animal` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_MonitoraUpdate_tb_tipo_animal`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraUpdate_tb_tipo_animal` BEFORE UPDATE ON `tb_tipo_animal` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
--
-- Estrutura da tabela `tb_tipo_auditoria`
--

DROP TABLE IF EXISTS `tb_tipo_auditoria`;
CREATE TABLE `tb_tipo_auditoria` (
  `sg_tipo_auditoria` char(3) NOT NULL,
  `nm_tipo_auditoria` varchar(30) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `tb_tipo_auditoria`
--

INSERT INTO `tb_tipo_auditoria` (`sg_tipo_auditoria`, `nm_tipo_auditoria`) VALUES
('INS', 'Insert'),
('UPD', 'Update');
...
DROP TABLE IF EXISTS `tb_tipo_denuncia`;
...
--
-- Extraindo dados da tabela `tb_tipo_denuncia`
--

INSERT INTO `tb_tipo_denuncia` (`cd_tipo_denuncia`, `ds_tipo_denuncia`) VALUES
(1, 'TESTE');
...
--
-- Acionadores `tb_tipo_endereco`
--
DROP TRIGGER IF EXISTS `tr_MonitoraInsert_tb_tipo_endereco`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraInsert_tb_tipo_endereco` AFTER INSERT ON `tb_tipo_endereco` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_MonitoraUpdate_tb_tipo_endereco`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraUpdate_tb_tipo_endereco` BEFORE UPDATE ON `tb_tipo_endereco` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
--
-- Acionadores `tb_tipo_pagamento`
--
DROP TRIGGER IF EXISTS `tr_MonitoraInsert_tb_tipo_pagamento`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraInsert_tb_tipo_pagamento` AFTER INSERT ON `tb_tipo_pagamento` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_MonitoraUpdate_tb_tipo_pagamento`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraUpdate_tb_tipo_pagamento` BEFORE UPDATE ON `tb_tipo_pagamento` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
--
-- Acionadores `tb_tipo_telefone`
--
DROP TRIGGER IF EXISTS `tr_MonitoraInsert_tb_tipo_telefone`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraInsert_tb_tipo_telefone` AFTER INSERT ON `tb_tipo_telefone` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_MonitoraUpdate_tb_tipo_telefone`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraUpdate_tb_tipo_telefone` BEFORE UPDATE ON `tb_tipo_telefone` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
-- Acionadores `tb_uf`
--
DROP TRIGGER IF EXISTS `tr_MonitoraInsert_tb_uf`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraInsert_tb_uf` AFTER INSERT ON `tb_uf` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_MonitoraUpdate_tb_uf`;
DELIMITER $$
CREATE TRIGGER `tr_MonitoraUpdate_tb_uf` BEFORE UPDATE ON `tb_uf` FOR EACH ROW begin
				DECLARE cd_auditoria_atual int;
                SELECT max(cd_auditoria)+1 into cd_auditoria_atual from tb_auditoria;
				insert into tb_auditoria set 
                cd_auditoria = cd_auditoria_atual,
...
--
-- Índices para tabela `administrador_permissao`
--
...
--
-- Índices para tabela `cliente_pet`
--
...
--
-- Índices para tabela `pessoa_endereco`
--
...
ALTER TABLE `tb_auditoria`
  ADD PRIMARY KEY (`cd_auditoria`),
  ADD KEY `fk_tipo_auditoria` (`sg_tipo_auditoria`);
...
--
-- Índices para tabela `tb_grupo_passeio`
--
...
--
-- Índices para tabela `tb_passeador`
--
...
--
-- Índices para tabela `tb_passeio`
--
...
--
-- Índices para tabela `tb_tipo_animal`
--
...
--
-- Índices para tabela `tb_tipo_auditoria`
--
ALTER TABLE `tb_tipo_auditoria`
  ADD PRIMARY KEY (`sg_tipo_auditoria`);

--
-- Índices para tabela `tb_tipo_denuncia`
--
ALTER TABLE `tb_tipo_denuncia`
  ADD PRIMARY KEY (`cd_tipo_denuncia`);

--
-- Índices para tabela `tb_tipo_endereco`
--
ALTER TABLE `tb_tipo_endereco`
  ADD PRIMARY KEY (`cd_tipo_endereco`);

--
-- Índices para tabela `tb_tipo_pagamento`
--
ALTER TABLE `tb_tipo_pagamento`
  ADD PRIMARY KEY (`cd_tipo_pagamento`);

--
-- Índices para tabela `tb_tipo_telefone`
--
...
--
ALTER TABLE `tb_administrador`
  MODIFY `cd_administrador` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de tabela `tb_login`
--
ALTER TABLE `tb_login`
  MODIFY `cd_login` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=110;
...
--
ALTER TABLE `tb_pessoa`
  MODIFY `cd_pessoa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=111;
...
--
-- Limitadores para a tabela `tb_auditoria`
--
ALTER TABLE `tb_auditoria`
  ADD CONSTRAINT `fk_tipo_auditoria` FOREIGN KEY (`sg_tipo_auditoria`) REFERENCES `tb_tipo_auditoria` (`sg_tipo_auditoria`);
