...
CREATE PROCEDURE `atualizarPasseio` (IN `vlcd_passeador` INT)  begin
...
CREATE PROCEDURE `criarPasseio` (IN `vlcd_passeador` INT, IN `vlcd_status` CHAR(3), IN `vllat_passeador` FLOAT, IN `vllon_passeador` FLOAT)  begin
...
CREATE TABLE `tb_animal` (
  ...
  `ds_animal` varchar(50) DEFAULT NULL
...
INSERT INTO `tb_animal` (`cd_animal`, `ds_animal`) VALUES
(1, 'Cachorro');
...
INSERT INTO `tb_cor` (`cd_cor`, `ds_cor`) VALUES
(1, 'Abóbora'),
(2, 'Açafrão'),
(3, 'Amarelo'),
(4, 'Âmbar'),
...
CREATE TABLE `tb_denuncia` (
  ...
  `ds_denuncia` mediumtext DEFAULT NULL,
...
(61, 'cliente@cliente.com', '4983a0ab83ed86e0e7213c8783940193'),
...
(111, 'passeador@passeador.com', '99b3028d33971d8fd03ff88e43715a32');
...
INSERT INTO `tb_passeador` (`cd_passeador`, `cd_pessoa`, `cd_nivel`, `cd_login`) VALUES
(1, 21, 2, 21),
(2, 22, 5, 22),
(3, 23, 3, 23),
(4, 24, 1, 24),
...
CREATE TABLE `tb_passeio` (
  ...
  `ds_observacao` mediumtext DEFAULT NULL,
  `lat_passeador` float DEFAULT NULL,
  `lon_passeador` float DEFAULT NULL,
  `lat_cliente` float DEFAULT NULL,
  `lon_cliente` float DEFAULT NULL,
  `cd_status` char(3) DEFAULT NULL,
  `dt_passeio` datetime DEFAULT NULL,
  `vl_passeio` decimal(7,2) DEFAULT NULL,
  `cd_tipo_pagamento` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(61, '50138286184', '58406460', 'CLIENTE TESTE', '2000-07-06'),
...
(112, '52593386865', '225554132', 'TESTE PASSEADOR', '2000-02-02');
...
CREATE TABLE `tb_pet` (
  `cd_pet` int(11) NOT NULL,
  `nm_pet` varchar(70) DEFAULT NULL,
  `cd_cor` int(11) DEFAULT NULL,
  `dt_nascimento` date DEFAULT NULL,
  `cd_situacao` int(11) DEFAULT NULL,
...
INSERT INTO `tb_pet` (`cd_pet`, `nm_pet`, `cd_cor`, `dt_nascimento`, `cd_situacao`, `cd_tipo_animal`) VALUES
(1, 'PET TESTE', 47, '2019-08-20', 1, 21);
...
CREATE TABLE `tb_porte` (
  ...
  `ds_porte` varchar(50) DEFAULT NULL,
...
INSERT INTO `tb_porte` (`cd_porte`, `ds_porte`, `cd_animal`) VALUES
(1, 'Mini', 1),
(2, 'Pequeno', NULL),
(3, 'Médio', 1),
(4, 'Grande', 1);
...
CREATE TABLE `tb_situacao` (
  ...
  `ds_falecido` tinyint(4) DEFAULT NULL,
  `ds_gestante` tinyint(4) DEFAULT NULL,
  `ds_amamentando` tinyint(4) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tb_situacao` (`cd_situacao`, `ds_ativo`, `ds_falecido`, `ds_gestante`, `ds_amamentando`) VALUES
(1, 0, 0, 0, 0);
...
CREATE TABLE `tb_sos` (
  ...
  `ds_sos` mediumtext DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `tb_tipo_animal` (
  ...
  `ds_tipo_animal` varchar(50) DEFAULT NULL,
...
INSERT INTO `tb_tipo_animal` (`cd_tipo_animal`, `ds_tipo_animal`, `cd_porte`) VALUES
(1, 'Akita', 4),
(2, 'Basset hound', 4),
(3, 'Beagle', 3),
(4, 'Bichon frisé', 3),
(5, 'Boiadeiro australiano', 3),
(6, 'Border collie', 4),
(7, 'Boston terrier', 3),
(8, 'Boxer', 4),
(9, 'Buldogue francês', 4),
(10, 'Buldogue inglês', 4),
(11, 'Bull terrier', 3),
(12, 'Cane corso', 2),
(13, 'Cavalier king charles spaniel', 4),
(14, 'Chihuahua', 3),
(15, 'Chow chow', 4),
(16, 'Cocker spaniel inglês', 4),
(17, 'Dachshund', 3),
(18, 'Dálmata', 3),
(19, 'Doberman', 3),
(20, 'Dogo argentino', 3),
(21, 'Dogue alemão', 4),
(22, 'Fila brasileiro', 2),
(23, 'Golden retriever', 4),
(24, 'Husky siberiano', 3),
(25, 'Jack russell terrier', 3),
(26, 'Labrador retriever', 3),
(27, 'Lhasa apso', 3),
(28, 'Lulu da pomerânia', 3),
(29, 'Maltês', 3),
(30, 'Mastiff inglês', 4),
(31, 'Mastim tibetano', 4),
(32, 'Pastor alemão', 4),
(33, 'Pastor australiano', 4),
(34, 'Pastor de Shetland', 3),
(35, 'Pequinês', 3),
(36, 'Pinscher', 3),
(37, 'Pit bull', 3),
(38, 'Poodle', 3),
...
(43, 'Shiba', 2),
(44, 'Shih tzu', 3),
(45, 'Staffordshire bull terrier', 3),
(46, 'Weimaraner', 3),
(47, 'Yorkshire', 3);
...
CREATE TABLE `tb_tipo_pagamento` (
  ...
  `ds_tipo_pagamento` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Estrutura stand-in para vista `vwadministradorinfo`
-- (Veja abaixo para a view atual)
--
DROP VIEW IF EXISTS `vwadministradorinfo`;
CREATE TABLE `vwadministradorinfo` (
`cd_administrador` int(11)
...
--
-- Estrutura stand-in para vista `vwcidadeadministradores`
-- (Veja abaixo para a view atual)
--
DROP VIEW IF EXISTS `vwcidadeadministradores`;
CREATE TABLE `vwcidadeadministradores` (
`cd_administrador` int(11)
,`nm_pessoa` varchar(70)
...
--
-- Estrutura stand-in para vista `vwcidadeclientes`
-- (Veja abaixo para a view atual)
--
DROP VIEW IF EXISTS `vwcidadeclientes`;
CREATE TABLE `vwcidadeclientes` (
`cd_cliente` int(11)
,`nm_pessoa` varchar(70)
,`ds_cidade` varchar(70)
);
...
--
-- Estrutura stand-in para vista `vwcidadepasseadores`
-- (Veja abaixo para a view atual)
--
DROP VIEW IF EXISTS `vwcidadepasseadores`;
CREATE TABLE `vwcidadepasseadores` (
`cd_passeador` int(11)
,`nm_pessoa` varchar(70)
,`ds_cidade` varchar(70)
);
...
--
-- Estrutura stand-in para vista `vwclienteinfo`
-- (Veja abaixo para a view atual)
--
DROP VIEW IF EXISTS `vwclienteinfo`;
CREATE TABLE `vwclienteinfo` (
`cd_cliente` int(11)
,`nm_pessoa` varchar(70)
,`cd_cpf` char(11)
);
...
--
-- Estrutura stand-in para vista `vwenderecossp`
-- (Veja abaixo para a view atual)
--
DROP VIEW IF EXISTS `vwenderecossp`;
CREATE TABLE `vwenderecossp` (
`cd_endereco` int(11)
...
--
-- Estrutura stand-in para vista `vwpasseadorinfo`
-- (Veja abaixo para a view atual)
--
DROP VIEW IF EXISTS `vwpasseadorinfo`;
CREATE TABLE `vwpasseadorinfo` (
`cd_passeador` int(11)
,`nm_pessoa` varchar(70)
,`cd_cpf` char(11)
);
...
--
-- Estrutura stand-in para vista `vwpermissaototal`
-- (Veja abaixo para a view atual)
--
DROP VIEW IF EXISTS `vwpermissaototal`;
CREATE TABLE `vwpermissaototal` (
`cd_administrador` int(11)
,`nm_pessoa` varchar(70)
);
...
--
-- Estrutura stand-in para vista `vwpetdono`
-- (Veja abaixo para a view atual)
--
DROP VIEW IF EXISTS `vwpetdono`;
CREATE TABLE `vwpetdono` (
`cd_pet` int(11)
,`nm_pet` varchar(70)
,`nm_pessoa` varchar(70)
);
...
--
-- Estrutura stand-in para vista `vwporteracas`
-- (Veja abaixo para a view atual)
--
DROP VIEW IF EXISTS `vwporteracas`;
CREATE TABLE `vwporteracas` (
`RacasAnimais` varchar(50)
,`Porte` varchar(50)
);
...
--
-- Estrutura stand-in para vista `vwtipoenderecospessoas`
-- (Veja abaixo para a view atual)
--
DROP VIEW IF EXISTS `vwtipoenderecospessoas`;
CREATE TABLE `vwtipoenderecospessoas` (
`cd_pessoa` int(11)
,`nm_pessoa` varchar(70)
,`ds_tipo_endereco` varchar(50)
);

-- --------------------------------------------------------

--
-- Estrutura para vista `vwadministradorinfo`
--
...
--
-- Estrutura para vista `vwcidadeadministradores`
--
...
--
-- Estrutura para vista `vwcidadeclientes`
--
...
--
-- Estrutura para vista `vwcidadepasseadores`
--
...
--
-- Estrutura para vista `vwclienteinfo`
--
...
--
-- Estrutura para vista `vwenderecossp`
--
...
--
-- Estrutura para vista `vwpasseadorinfo`
--
...
--
-- Estrutura para vista `vwpermissaototal`
--
...
--
-- Estrutura para vista `vwpetdono`
--
...
--
-- Estrutura para vista `vwporteracas`
--
...
--
-- Estrutura para vista `vwtipoenderecospessoas`
--
...
ALTER TABLE `tb_denuncia`
  ...
  ADD KEY `fk_denuncia_tipo_denuncia` (`cd_tipo_denuncia`);
...
ALTER TABLE `tb_passeio`
  ...
  ADD KEY `fk_passeio_pet` (`cd_pet`),
  ADD KEY `fk_passeio_status` (`cd_status`),
  ADD KEY `fk_passeio_tipo_pagamento` (`cd_tipo_pagamento`);
...
ALTER TABLE `tb_pet`
  ...
  ADD KEY `fk_pet_cor` (`cd_cor`),
  ADD KEY `fk_pet_situacao` (`cd_situacao`),
  ADD KEY `fk_pet_tipo_animal` (`cd_tipo_animal`);
...
ALTER TABLE `tb_porte`
  ...
  ADD KEY `fk_porte_animal` (`cd_animal`);
...
ALTER TABLE `tb_sos`
  ...
  ADD KEY `pk_sos_passeio` (`cd_passeio`);
...
--
ALTER TABLE `tb_login`
  MODIFY `cd_login` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=112;
...
--
ALTER TABLE `tb_pessoa`
  MODIFY `cd_pessoa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=113;
...
ALTER TABLE `tb_denuncia`
  ...
  ADD CONSTRAINT `fk_denuncia_tipo_denuncia` FOREIGN KEY (`cd_tipo_denuncia`) REFERENCES `tb_tipo_denuncia` (`cd_tipo_denuncia`);
...
ALTER TABLE `tb_passeio`
  ...
  ADD CONSTRAINT `fk_passeio_pet` FOREIGN KEY (`cd_pet`) REFERENCES `tb_pet` (`cd_pet`),
  ADD CONSTRAINT `fk_passeio_status` FOREIGN KEY (`cd_status`) REFERENCES `tb_status` (`cd_status`),
  ADD CONSTRAINT `fk_passeio_tipo_pagamento` FOREIGN KEY (`cd_tipo_pagamento`) REFERENCES `tb_tipo_pagamento` (`cd_tipo_pagamento`);

--
-- Limitadores para a tabela `tb_pet`
--
ALTER TABLE `tb_pet`
  ADD CONSTRAINT `fk_pet_cor` FOREIGN KEY (`cd_cor`) REFERENCES `tb_cor` (`cd_cor`),
  ADD CONSTRAINT `fk_pet_situacao` FOREIGN KEY (`cd_situacao`) REFERENCES `tb_situacao` (`cd_situacao`),
  ADD CONSTRAINT `fk_pet_tipo_animal` FOREIGN KEY (`cd_tipo_animal`) REFERENCES `tb_tipo_animal` (`cd_tipo_animal`);

--
-- Limitadores para a tabela `tb_porte`
--
ALTER TABLE `tb_porte`
  ADD CONSTRAINT `fk_porte_animal` FOREIGN KEY (`cd_animal`) REFERENCES `tb_animal` (`cd_animal`);

--
-- Limitadores para a tabela `tb_sos`
--
ALTER TABLE `tb_sos`
  ADD CONSTRAINT `pk_sos_passeio` FOREIGN KEY (`cd_passeio`) REFERENCES `tb_passeio` (`cd_passeio`);
