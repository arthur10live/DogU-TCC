...
--
-- Máquina: localhost
-- Data de Criação: 30-Ago-2019 às 19:12
...
-- Procedures
--
CREATE DEFINER=`arthur`@`localhost` PROCEDURE `criarUsuario`(vlcd_cpf CHAR(11), vlcd_rg char(9), vlnm_pessoa varchar(70), vlcd_email VARCHAR(80), vlcd_senha varchar(80), vldt_nascimento DATE)
begin
